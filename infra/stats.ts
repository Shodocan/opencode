      ...
      iceberg: {
        schema: {
          fields: [
            ...
            { name: "fallback_event", type: "string", required: false },
            { name: "fallback_from_provider", type: "string", required: false },
            { name: "fallback_from_model", type: "string", required: false },
            { name: "fallback_to_provider", type: "string", required: false },
            { name: "fallback_to_model", type: "string", required: false },
            { name: "fallback_reason", type: "string", required: false },
            { name: "fallback_attempts_total", type: "long", required: false },
            { name: "fallback_attempts_lower_level", type: "long", required: false },
            { name: "fallback_attempts_runner_level", type: "long", required: false },
            { name: "fallback_hop", type: "long", required: false },
            { name: "fallback_tried_chain", type: "string", required: false },
            { name: "fallback_eligible", type: "boolean", required: false },
            { name: "fallback_timeout_blocked", type: "boolean", required: false },
            { name: "fallback_exhausted", type: "boolean", required: false },
            { name: "fallback_committed_turn_failed", type: "boolean", required: false },
