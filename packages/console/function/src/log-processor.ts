...
function toLakeEvent(time: string, data: Record<string, unknown>) {
  return {
    ...
    fallback_event: string(data, "fallback.event"),
    fallback_from_provider: string(data, "fallback.from.provider"),
    fallback_from_model: string(data, "fallback.from.model"),
    fallback_to_provider: string(data, "fallback.to.provider"),
    fallback_to_model: string(data, "fallback.to.model"),
    fallback_reason: string(data, "fallback.reason"),
    fallback_attempts_total: integer(data, "fallback.attempts.total"),
    fallback_attempts_lower_level: integer(data, "fallback.attempts.lower_level"),
    fallback_attempts_runner_level: integer(data, "fallback.attempts.runner_level"),
    fallback_hop: integer(data, "fallback.hop"),
    fallback_tried_chain: string(data, "fallback.tried_chain"),
    fallback_eligible: boolean(data, "fallback.eligible"),
    fallback_timeout_blocked: boolean(data, "fallback.timeout_blocked"),
    fallback_exhausted: boolean(data, "fallback.exhausted"),
    fallback_committed_turn_failed: boolean(data, "fallback.committed_turn_failed"),
