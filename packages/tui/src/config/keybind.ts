...
export const Definitions = {
  ...
  input_submit: keybind("return,linefeed,kpenter", "Submit input"),
  ...
  "dialog.select.submit": keybind("return,linefeed,kpenter", "Submit selected dialog item"),
  "dialog.prompt.submit": keybind("return,linefeed,kpenter", "Submit dialog prompt"),
  ...
  "prompt.autocomplete.select": keybind("return,linefeed,kpenter", "Select autocomplete item"),
